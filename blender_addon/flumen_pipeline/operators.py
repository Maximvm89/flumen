...
from .light_links import (  # light-linking snapshot/restore (cache updates)
    FLUMEN_OT_save_light_links, FLUMEN_OT_load_light_links)
...
CLASSES = (
    ...
    FLUMEN_OT_save_light_links,
    FLUMEN_OT_load_light_links,
